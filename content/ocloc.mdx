...
image: "/blog/ocloc/github-preview.png"
pinned: true
pinnedOrder: 3
---
...
Meet <a href="https://github.com/adhishthite/ocloc" target="\_blank" rel="noopener noreferrer" style={{color: "rgb(245, 135, 61)"}}>ocloc</a> (pronounced "oh-clock"). It's a lines-of-code counter that runs at about 2.3 million lines per second on my M2 MacBook. The entire Elasticsearch codebase (31,000 files, 5.5 million lines) analyzed in 2.35 seconds.
...
Two commands, and your crate is live on <a href="https://crates.io/crates/ocloc" target="\_blank" rel="noopener noreferrer" style={{color: "rgb(245, 135, 61)"}}>crates.io</a> and anyone can install it with `cargo install ocloc`.
