...
This post walks through setting up the Elastic Connector locally with Docker, step by step, with instructions and screenshots along the way.
...
>
> This guide covers the Docker method.
...
The Elastic Connector is now running locally via Docker and syncing Confluence into Elasticsearch.
