  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-16 z-30 mx-auto hidden md:flex h-14">
        ...
        <Dock className="z-50 pointer-events-auto relative mx-auto flex min-h-full h-full items-center px-1 bg-background [box-shadow:0_0_0_1px_oklch(var(--dock-outline)),0_4px_6px_oklch(var(--dock-shadow-soft)),0_12px_24px_oklch(var(--dock-shadow-strong))] transform-gpu dark:[border:1px_solid_oklch(var(--dock-dark-border))] dark:[box-shadow:0_-20px_80px_-20px_oklch(var(--dock-dark-inset))_inset]">
          {DATA.navbar.map((item) => (
